...
export function middleware(request: NextRequest) {
  ...
  if (cspMode !== 'off') {
    const cspDirectives = [
      ...
      "connect-src 'self' https://omnifolio.app https://www.omnifolio.app https://api.exchangerate-api.com https://api.replicate.com https://*.supabase.co https://generativelanguage.googleapis.com https://maps.googleapis.com https://*.googleapis.com https://api.coingecko.com https://query1.finance.yahoo.com https://query2.finance.yahoo.com https://*.tradingview.com https://*.tradingview-widget.com wss://*.supabase.co https://accounts.google.com https://*.google-analytics.com https://www.google-analytics.com https://*.g.doubleclick.net https://stats.g.doubleclick.net https://analytics.google.com https://www.googleadservices.com https://googleads.g.doubleclick.net https://maps.google.com wss://stream.binance.com:9443 wss://ws-api.binance.com:443",
      "media-src 'self' blob: data: https://replicate.delivery",
