...
export const PLAN_FEATURES: Record<SubscriptionPlan, PlanFeature[]> = {
  STARTER: [
    ...
    { name: 'Omni AI Assistant', included: false },
  ],
  TRADER: [
    ...
    { name: 'Omni AI Assistant (10 msgs/day)', included: true },
    { name: 'SEC Filings Access', included: false, tooltip: 'SEC EDGAR filings and insider trading data' },
  ],
  INVESTOR: [
    ...
    { name: 'Omni AI Assistant (50 msgs/day)', included: true },
    { name: 'Priority Support', included: true },
  ],
  WHALE: [
    { name: 'Everything in Investor', included: true },
    { name: 'Omni AI Assistant (Unlimited + Voice)', included: true, tooltip: 'Gemini Powered with voice interaction' },
