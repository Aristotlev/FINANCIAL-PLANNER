# Fix Income Sources Table Error

## Issue
You are seeing the error: `Error fetching income_sources: "Could not find the table 'public.income_sources' in the schema cache"`.

This occurs because the `income_sources` table has not been created in your Supabase database yet.
...
## Alternative
If you have the Supabase CLI installed and linked, you can run:
```bash
supabase db reset
```
