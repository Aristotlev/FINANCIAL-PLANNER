...
const omniPlans: PriceTier[] = [
  {
    ...
    features: [
      ...
      { name: 'Lisa AI Assistant', isIncluded: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Lisa AI Assistant (10/day)', isIncluded: true },
      { name: 'Priority Support', isIncluded: false },
    ],
  },
  {
    ...
    features: [
      ...
      { name: 'Google Maps Integration', isIncluded: true },
      { name: 'Lisa AI Assistant (50/day)', isIncluded: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'SEC Filings Access', isIncluded: true },
      { name: 'Google Maps Integration', isIncluded: true },
      { name: 'Lisa AI Assistant (Unlimited)', isIncluded: true },
      { name: 'Priority Support', isIncluded: true },
