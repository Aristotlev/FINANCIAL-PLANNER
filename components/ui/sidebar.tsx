...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full px-4 py-4 hidden  md:flex md:flex-col bg-neutral-100 dark:bg-black w-[300px] flex-shrink-0 border-r border-neutral-200 dark:border-neutral-800",
          className
        )}
        animate={{
  ...
  if (link.onClick) {
      return (
        <button
            ...
            className={cn(
                "flex items-center justify-start gap-2  group/sidebar py-2 w-full bg-transparent border-none cursor-pointer",
                className
            )}
            {...props}
        >
